  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between">
        <div className="text-primary-400 text-3xl">
      ...
      <div className="flex flex-wrap gap-2 pt-2 border-t border-dark-800">
        {(project.tech_stack ?? []).map((tech) => (
          <span
            key={tech}
            className="text-xs font-mono text-primary-400 bg-primary-500/10 px-2 py-0.5 rounded"
          >
            {tech}
          </span>
        ))}
  ...
  return (
    <div className="card p-6 animate-pulse space-y-4">
      <div className="flex justify-between">
        <div className="w-10 h-10 bg-dark-700 rounded" />
        <div className="flex gap-3">
      ...
      <div className="section-container">
        ...
        {error && (
          <div className="text-center text-dark-500 py-12">
            <p className="text-red-400 mb-2">Could not load projects</p>
        ...
        {!loading && projects.length === 0 && !error && (
          <p className="text-center text-dark-500 py-12">No projects yet.</p>
        )}
