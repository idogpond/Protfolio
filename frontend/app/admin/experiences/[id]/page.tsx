...
export default function EditExperiencePage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <Link href="/admin/experiences" className="text-muted-foreground/70 hover:text-primary-400 text-sm transition-colors">
          {t("backToList")}
        </Link>
      ...
      <div className="card p-6">
        <ExperienceForm
          defaultValues={{
            ...
            period_en:      experience.period_en,
            period_th:      experience.period_th ?? "",
